...
var ReportByNet = /** @class */ (function () {
    function ReportByNet(stores_count, orders_count, sold_orders, time_out_canceled, customer_canceled_orders, no_end_status_ord, canceled_ord, no_receive_status_ord) {
        this.stores_count = stores_count;
        this.orders_count = orders_count;
        this.sold_orders = sold_orders;
        this.time_out_canceled = time_out_canceled;
